...
int main()
{
    auto x1 = std::make_shared<Value>(1);
    auto w1 = std::make_shared<Value>(2);
    auto x2 = std::make_shared<Value>(3);
    auto w2 = std::make_shared<Value>(4);
    // std::cout << "a is " << a << std::endl;
    // std::cout << "b is " << b << std::endl;
    // std::cout << "a's gradient is " << a->GetGradient() << std::endl;

    auto x1w1 = x1 * w1;
    auto x2w2 = x2 * w2;
    auto DotProduct = x1w1 + x2w2;
    auto poggers = DotProduct->ReLU();

    std::cout << x1->getGradient() << std::endl;
    poggers->printTopo();
    poggers->backwards();
    std::cout << x1->getGradient() << std::endl;
    std::cout << w1->getGradient() << std::endl;
    std::cout << x2->getGradient() << std::endl;
    std::cout << w2->getGradient() << std::endl;
